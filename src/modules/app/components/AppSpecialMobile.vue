<template>
  <div class="AppSpecialMobile">
    <div class="AppSpecialMobile__name">
      {{ special_text['text_' + selectedLang] }}
    </div>

    <div class="AppSpecialMobile__top container">
      <div class="AppSpecialMobile__top__header">
        {{ name }}
      </div>

      <img :src="base_url + imageUrl" :alt="imageAlt" class="AppSpecialMobile__top__image">

      <div class="AppSpecialMobile__top__cover">
        <div class="AppSpecialMobile__top__cover__triangle"></div>
      </div>
    </div>
    <div class="AppSpecialMobile__bottom container">
      <div class="AppSpecialMobile__bottom__subheader">
        {{ texts[11]['text_' + selectedLang] }}
      </div>

      <div class="AppSpecialMobile__bottom__content">
        <div class="AppSpecialMobile__bottom__content__specifications">
        ...
        <div class="AppSpecialMobile__bottom__content__youtube" @click="href(yt_link)">
      ...
      <div class="AppSpecialMobile__bottom__content__button showForm">
        <span>
          {{ order_text['text_' + selectedLang] }}
        </span>
      </div>
    </div>
    <div class="AppSpecialMobile__price">
...
.AppSpecialMobile {
  ...
  &__bottom {
    background: linear-gradient(180deg, #363636 0%, #A40005 100%);
